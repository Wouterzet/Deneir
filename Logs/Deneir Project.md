...
- The [[Deneir Project]] was designed to use the energy from a dimensional rift (triggered by the [[Gateway Station]]) to send probe data from the [[Construct Intelligence Center]] into the past.
